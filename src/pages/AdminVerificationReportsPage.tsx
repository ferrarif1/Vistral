    ...
    <Card className="workspace-overview-hero">
      <div className="workspace-overview-hero-grid">
        <div className="workspace-overview-copy stack">
          <small className="workspace-eyebrow">{t('Operations Audit')}</small>
          <h1>{t('Admin Verification Reports')}</h1>
          <p className="muted">
      ...
      <section className="workspace-overview-signal-grid">
        <Card as="article" className="workspace-signal-card">
          <div className="workspace-signal-top">
            <h3>{t('Filtered reports')}</h3>
            <small className="muted">{t('Reports matching the current filters and pagination scope.')}</small>
          </div>
          <strong className="metric">{filteredItems.length}</strong>
        </Card>
        <Card as="article" className={`workspace-signal-card${summary.failed > 0 ? ' attention' : ''}`}>
          <div className="workspace-signal-top">
            <h3>{t('Failed checks')}</h3>
            <small className="muted">{t('Aggregate failed checks across all reports in this workspace view.')}</small>
          </div>
          <strong className="metric">{summary.failedChecks}</strong>
        </Card>
        <Card as="article" className="workspace-signal-card">
          <div className="workspace-signal-top">
            <h3>{t('Current page')}</h3>
            <small className="muted">{t('Pagination stays stable while filters update quietly in the background.')}</small>
          </div>
        ...
        <Card as="article" className="workspace-signal-card">
          <div className="workspace-signal-top">
            <h3>{t('Page size')}</h3>
            <small className="muted">{t('Visible report density per page.')}</small>
          </div>
          <strong className="metric">{pageSize}</strong>
        </Card>
      </section>
          ...
          <Card>
            <div className="workspace-section-header">
              <div className="stack tight">
                <h3>{t('Report filters')}</h3>
                <small className="muted">
                  {t('Use primary filters first, then expand advanced options when triage needs more precision.')}
                </small>
              </div>
            </div>
