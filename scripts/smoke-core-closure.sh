...
run_step "smoke:navigation-context-hygiene"
...
run_step "smoke:dataset-delete-consistency"
run_step "smoke:runtime-success"
run_step "smoke:conversation-actions"
run_step "smoke:conversation-goal-orchestration"
run_step "smoke:conversation-history-clear"
...
run_step_with_env "smoke:real-closure" \
  ...
  REAL_CLOSURE_ALLOW_OCR_CALIBRATED_REGISTRATION="${REAL_CLOSURE_ALLOW_OCR_CALIBRATED_REGISTRATION:-true}"
run_step_with_env "smoke:ocr-closure" \
  OCR_CLOSURE_REQUIRE_REAL_MODE="${OCR_CLOSURE_REQUIRE_REAL_MODE:-true}"
