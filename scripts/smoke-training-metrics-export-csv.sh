...
train_resp="$(curl -sS -c "${COOKIE_FILE}" -b "${COOKIE_FILE}" \
  ...
  -d '{"name":"metrics-export-csv-test","task_type":"detection","framework":"yolo","dataset_id":"d-2","dataset_version_id":"dv-2","base_model":"yolo11n","config":{"epochs":"9","batch_size":"2","learning_rate":"0.0007"}}')"
